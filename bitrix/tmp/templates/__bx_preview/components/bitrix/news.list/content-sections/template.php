					...
					<div class="item_wrap colored_theme_hover_bg-block box-shadow rounded3 bordered-block " >
						<div class="item noborder <?=($bShowSectionImage ? '' : ' wti')?>  <?=$arParams['IMAGE_CATALOG_POSITION'];?> clearfix" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
							...
							<div class="body-info">
								...
								<?endif;?> -->
								<div class="order-service-btn" data-event="jqm" data-param-form_id="SERVICES" data-name="order_services" data-autoload-service="<?=$arItem['NAME']?>" data-autoload-project="<?=$arItem['NAME']?>">Заказать услугу</div>
