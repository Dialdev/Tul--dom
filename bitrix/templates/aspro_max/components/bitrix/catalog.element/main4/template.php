							...
							if($arResult["MORE_PHOTO"]){?>
								<?foreach($arResult["MORE_PHOTO"] as $i => $arImage){
									...
									<div id="photo-<?=$i?>" class="product-detail-gallery__item product-detail-gallery__item--middle text-center">
										<?if(!$isEmpty){?>
											<a href="<?=($arFirstPhoto["BIG"]["src"]);?>" <?=($bIsOneImage ? '' : 'data-fancybox="gallery"')?> class="product-detail-gallery__link <?=($viewImgType=="POPUP" ? "popup_link fancy" : "line_link");?>" title="<?=$title;?>">
