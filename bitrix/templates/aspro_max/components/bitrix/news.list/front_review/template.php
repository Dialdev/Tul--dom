...
<div id = "text-wraper" style = "background-color: white;max-width:1560px; margin:0 auto;">
<h1 style = "padding-left: 30px; padding-right: 30px; margin-top:10px; margin-bottom:15px">ТулДом – ваш надежный партнер в мире строительных и отделочных материалов</h1>
...
<h2 style = "padding-left: 30px; padding-right: 30px; margin-top:0px; margin-bottom:10px">Наши преимущества:</h2>
...
<li>Оперативная доставка. Самовывоз осуществляется со склада по адресу Тула, Ленинский район, с. Маслово, д.131а</li>
</ul>
