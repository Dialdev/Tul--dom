<?CMax::checkRestartBuffer();?>							<?IncludeTemplateLangFile(__FILE__);?>
							<?if(!$isIndex):?>
...
let btn_block1 = document.getElementsByClassName('btn-exlg to-cart btn btn-default transition_bg animate-load ');
let btn_block2 = document.getElementsByClassName('btn-lg to-cart btn btn-default transition_bg animate-load');

	for(i in btn_block1){
		btn_block1[i].onclick = function(){
alert('Товар добавлен в корзину');
};
};
	for(i in btn_block2){
		btn_block2[i].onclick = function(){
alert('Товар добавлен в корзину');
};
};
</script>
