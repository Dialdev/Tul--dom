...
<div class="wrapper_inner_half row flexbox shop-detail1 clearfix" itemscope itemtype="http://schema.org/Organization">
	<div class="item item-shop-detail1  <?=($showMap ? 'col-md-6' : 'col-md-12')?>">
		<div class="left_block_store <?=($showMap ? '' : 'margin0')?>">
			<div class="top_block">
				<div class="contacts_img "><?$APPLICATION->IncludeFile(SITE_DIR."include/contacts-site-image.php", Array(), Array("MODE" => "html", "NAME" => "Image"));?></div>
				...
				<div class="feedback item">
					<div class="wrap">
						<?//if($arShop['DESCRIPTION']):?>
							<div itemprop="description" class="previewtext muted777"><?$APPLICATION->IncludeFile(SITE_DIR."include/contacts-about.php", Array(), Array("MODE" => "html", "NAME" => "Contacts about"));?></div>
						<?//endif;?>
						<?if($bUseFeedback):?>
