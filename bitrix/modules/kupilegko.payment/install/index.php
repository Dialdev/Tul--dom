...
Class kupilegko_payment extends CModule {

    var $MODULE_ID = 'kupilegko.payment';
    var $MODULE_VERSION;
    ...
    function __construct() {
        ...
        $this->MODULE_NAME =  Loc::getMessage('ALFABANK_PAYMENT_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('ALFABANK_PAYMENT_MODULE_DESCRIPTION');
        $this->PARTNER_NAME = Loc::getMessage('ALFABANK_PAYMENT_PARTNER_NAME');
        $this->PARTNER_URI = Loc::getMessage('ALFABANK_PAYMENT_PARTNER_URI');
    ...
    function InstallFiles($arParams = array()) {
        ...
        //CopyDirFiles($this->MODULE_PATH . "/install/setup/alfabank", $_SERVER['DOCUMENT_ROOT'] . '/alfabank/');
