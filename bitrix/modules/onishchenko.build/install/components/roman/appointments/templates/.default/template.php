...
?>
<div class="form-window-wrap form-appointments">
    <div class="form-window">
        <div class="form-window-title">
            <h4><?=GetMessage('ORDER_SERVICE')?></h4>
            <a href="#" class="close">&times;</a>
        </div>
        <div class="form-wrap">
            <p id="message" style="padding: 20px 0px 20px 0px;;color:red;font-weight:bold;"></p>
            <form class="contact-form" name="appointments">
               <input class="text-input" name="name" type="text"  placeholder="<?=GetMessage('NAME_APPOINTMENTS')?>">
               ...
               <input class="text-input" name="service" type="text" disabled >
               <textarea name="message" class="message" placeholder="<?=GetMessage('MESSAGE')?>"></textarea>
                <?=bitrix_sessid_post()?>
                <?if($arResult['RECAPTCHA'] == 'Y'):?>
               <div id="recaptcha-appointments-form" class="g-recaptcha" data-sitekey="<?=RECAPTCHA_OPEN_KEY?>"></div>
               <?endif;?>
            </form>
