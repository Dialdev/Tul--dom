   ...
   <form class="contact-form">
      <div class="row">
         <fieldset class="column column-1-2">
            ...
            <input class="text-input"  name="subject" type="text" placeholder="<?=GetMessage('SUBJECT')?>" >
             <?=bitrix_sessid_post()?>
             <?if($arResult['RECAPTCHA'] == 'Y'):?>
            <div id="recaptcha-question-faq-form" class="g-recaptcha" data-sitekey="<?=RECAPTCHA_OPEN_KEY?>"></div>
             <?endif;?>
         </fieldset>
         <fieldset class="column column-1-2">
