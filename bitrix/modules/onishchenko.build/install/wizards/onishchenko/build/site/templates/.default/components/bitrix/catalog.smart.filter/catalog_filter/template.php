...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section container-fluid">
		<div>
         <h6 class="box-header bx-filter-title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></h6>
      </div>
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						...
						<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="bx-filter-parameters-box-hint"><?=$arItem["NAME"]?>
								...
								<?endif?>
                        <span class="template-arrow-menu filter-icon <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif;?>"></span>
							</span>
						</div>
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								case "A"://NUMBERS_WITH_SLIDER
									...
									<div class="col-xs-10 col-xs-offset-1 bx-ui-slider-track-container">
										<div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
											...
											<div class="bx-ui-slider-part p5"><span class="right-price"><?=$value5?></span></div>
								...
								case "G"://CHECKBOXES_WITH_PICTURES
									?>
									<div class="col-xs-12">
										<div class="bx-filter-param-btn-inline checkbox">
								...
								case "P"://DROPDOWN
									...
									?>
									<div class="col-xs-12" style="padding: 6px 7px 7px 15px;">
