...
<?Asset::getInstance()->addJs(DEFAULT_TEMPLATE_PATH."/rs-plugin/js/jquery.themepunch.tools.min.js");?>
<?Asset::getInstance()->addJs(DEFAULT_TEMPLATE_PATH."/rs-plugin/js/jquery.themepunch.revolution.min.js");?>
<?Asset::getInstance()->addJs(DEFAULT_TEMPLATE_PATH."/js/jquery.easing.1.3.min.js");?>
<?Asset::getInstance()->addJs(DEFAULT_TEMPLATE_PATH."/js/jquery.carouFredSel-6.2.1-packed.js");?>
<?Asset::getInstance()->addJs(DEFAULT_TEMPLATE_PATH."/js/jquery.touchSwipe.min.js");?>
...
<?Asset::getInstance()->addJs(DEFAULT_TEMPLATE_PATH."/js/slider.js");?>
