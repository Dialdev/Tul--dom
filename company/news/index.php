...
$APPLICATION->SetPageProperty("title", "Новости 2020");
$APPLICATION->SetPageProperty("description", "Купить стройматериалы в Туле стало проще! Заказывайте строительные материалы в интернет-магазине Тулдом.");
